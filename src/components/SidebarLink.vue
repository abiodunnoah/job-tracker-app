...
const linkClasses = computed(() => [
  "sidebar-link",
  props.active ? "sidebar-link--active" : "",
]);
...
<template>
  <router-link v-if="to" :to="to" :class="linkClasses">
    <span class="sidebar-icon" v-html="iconSvg"></span>
    <span class="sidebar-label">{{ label }}</span>
  </router-link>
  <div v-else :class="linkClasses" @click="$emit('click')">
    <span class="sidebar-icon" v-html="iconSvg"></span>
    <span class="sidebar-label">{{ label }}</span>
  </div>
</template>
